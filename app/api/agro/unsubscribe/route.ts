...
<head>
    ...
    <title>${title} | DEVLINI Agro</title>
</head>
<body style="margin:0;display:flex;min-height:100vh;align-items:center;justify-content:center;background-color:#fafafa;font-family:system-ui,sans-serif;">
    <div style="max-width:420px;padding:40px 24px;text-align:center;">
        ...
        <a href="/agro" style="display:inline-block;margin-top:28px;background-color:#059669;color:#ffffff;font-size:14px;font-weight:bold;text-decoration:none;padding:12px 24px;border-radius:12px;">Voltar ao DEVLINI Agro</a>
    </div>
</body>
</html>`
}
...
export async function GET(request: Request) {
    ...
    return new Response(
        htmlPage(
            "Inscrição cancelada",
            "Você não vai mais receber o briefing diário do DEVLINI Agro. Pode voltar quando quiser!"
        ),
        {
            headers: { "Content-Type": "text/html; charset=utf-8" },
        }
