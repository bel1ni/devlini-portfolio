...
export const metadata: Metadata = {
  ...
  description:
    "Como o devlini.com e a seção BELAGRO coletam e usam informações durante a navegação.",
  alternates: {
  ...
  return (
    <div className="mx-auto max-w-3xl py-8">
      ...
      <p className="mt-5 text-base leading-7 text-zinc-600">
        O devlini.com — incluindo a seção de notícias BELAGRO — é um
      ...
      <p className="mt-3 text-base leading-7 text-zinc-600">
        O BELAGRO organiza notícias de fontes externas por meio de RSS,
