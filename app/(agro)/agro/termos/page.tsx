...
export const metadata: Metadata = {
  title: "Termos de Uso",
  description:
    "Termos de uso do devlini.com e da seção de notícias DEVLINI Agro.",
  alternates: {
  ...
  return (
    <div className="mx-auto max-w-3xl py-8">
      ...
      <p className="mt-5 text-base leading-7 text-zinc-600">
        Ao acessar o devlini.com e a seção DEVLINI Agro, você concorda com os
      ...
      <p className="mt-3 text-base leading-7 text-zinc-600">
        O DEVLINI Agro fornece conteúdo editorial, resumos de notícias e links
      ...
      <p className="mt-3 text-base leading-7 text-zinc-600">
        ...
        veículos originais. O DEVLINI Agro atua como agregador e direciona
