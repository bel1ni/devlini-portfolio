...
export const metadata: Metadata = {
  title: "Sobre",
  description:
    "O que é o DEVLINI Agro: portal de notícias do agronegócio brasileiro com curadoria automatizada e resumos por IA.",
  alternates: {
  ...
  return (
    <div className="mx-auto max-w-3xl py-8">
      ...
      <h1 className="mt-3 text-2xl font-bold tracking-tight text-zinc-900 sm:text-3xl">
        Sobre o DEVLINI Agro
      </h1>

      <p className="mt-5 text-base leading-7 text-zinc-600">
        O DEVLINI Agro é a seção de notícias do agronegócio do{" "}
